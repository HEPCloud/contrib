{
    ...
    "match": {
        ...
        "factory": {
            ...
            "collectors": [
                {
                    "DN": "@TEMPLATE_FACTORY_DN@",
                    "comment": "Test Factory",
                    "factory_identity": "gfactory@@TEMPLATE_FACTORY@",
                    "my_identity": "decisionengine_service@@TEMPLATE_FACTORY@",
                    "node": "@TEMPLATE_FACTORY@"
                }
            ]
        },
        "job": {
    ...
    "security": {
        ...
        "credentials": [
            {
                "absfname": "@TEMPLATE_SciToken_PATH@",

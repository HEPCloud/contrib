...
class GCEBillCalculator(object):
    ...
    def _downloadBillFiles(self):
        ...
        # Not an actual secret or one of our accounts, it's a generic Google account for oauth
        # see: https://stackoverflow.com/questions/57557552/wrong-project-in-google-sdk
...
if __name__ == "__main__":
    ...
    # Unit test for the GCE billing library
    os.setuid(53431)

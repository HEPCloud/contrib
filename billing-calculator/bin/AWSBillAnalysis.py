...
class AWSBillCalculator(object):
    ...
    def sendDataToGraphite(self, CorrectedBillSummaryDict ):
        """ Send the corrected bill summary dictionary to the Grafana dashboard """
    ...
    def _applyBillCorrections(self, BillSummaryDict):
        ...
        #    discounts
        # 2) the .csv does not include the discount of 7.25%. For all of the non-data
        #    egress charges, it shows LIST price (Orbitera reflects the discount)
...
class AWSBillAlarm(object):
    ...
    def sendDataToGraphite(self, alarmConditionsDict ):
        """ Send the alarm condition dictionary to the Grafana dashboard """
...
class AWSBillDataEgress(object):
    ...
    def sendDataToGraphite(self, dataEgressConditionsDict ):
        """Send the data egress condition dictionary to the Grafana dashboard """ 
...
if __name__ == "__main__":
    ...
    # Unit tests for the AWS Calculations
    os.setuid(53431)
